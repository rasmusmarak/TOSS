...
def create_mesh():
    ...
    print("Reading file...")
    mesh_points, mesh_triangles = read_pk_file("/Users/rasmus/Master Thesis/My Repositories/67P-Swarm/Introductory Tests/3dmeshes/churyumov-gerasimenko.pk")
    ...
    tgen.write("/Users/rasmus/Master Thesis/My Repositories/67P-Swarm/Introductory Tests/mesh/67P/churyumov-gerasimenko.vtk")

    # Print the input files for the C++ implementation of the Polyhedral Model
    print("Writing polyhedron-cpp input files..")
    write_to_node_faces_ele_file("/Users/rasmus/Master Thesis/My Repositories/67P-Swarm/Introductory Tests/mesh/67P/", "churyumov-gerasimenko", nodes, mesh_triangles, elems)

    # Print the input files for the FORTRAN implementation of the Polyhedral Model by Tsoulis
    print("Writing FORTRAN files..")
    write__tsoulis_fortran_files("/Users/rasmus/Master Thesis/My Repositories/67P-Swarm/Introductory Tests/mesh/67P/", mesh_points, mesh_triangles)

    # Write other files
    print("Writing other files...")
    write_other("/Users/rasmus/Master Thesis/My Repositories/67P-Swarm/Introductory Tests/mesh/67P/", "churyumov-gerasimenko.ply", nodes, mesh_triangles)
